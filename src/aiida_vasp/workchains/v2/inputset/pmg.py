...
class PymatgenInputSet(InputSet):
    ...
    def get_input_dict(self, structure, raw_python=False) -> Union[dict, orm.Dict]:
        """
...
def pmg_kpoints2kpointsdata(pmg_kpoints):
    ...
    kpoints.set_kpoints_mesh(mesh, offset=shifts)
    kpoints.base.attributes.set('vasp_centering', centering)
    return kpoints
