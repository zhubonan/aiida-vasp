...
class VtstNebOutcarParser(OutcarParser):
    ...
    def _parse_file(self, inputs):
        """Parse the items and additional NEB related data"""
        result = super()._parse_file(inputs)
        _parse_neb_outputs(self._file_path, result)
        return result
    ...
    def neb_data(self):
        ...
        Parsed NEB results
        """
        return self._parsed_data.get('neb_data')

    @property
    def forces(self):
        """Parsed forces"""
        return self._parsed_data.get('outcar-forces')

    @property
    def positions(self):
        """Parsed forces"""
        return self._parsed_data.get('outcar-positions')

    @property
    def cell(self):
        """Parsed cell vectors"""
        return self._parsed_data.get('outcar-cell')
...
def _parse_neb_outputs(path, inputs):  # pylint: disable=too-many-branches,too-many-statements
    """
