...
def main(code_string, incar, kmesh, structure, potential_family, potential_mapping, options):
    ...
    # Organize settings
    settings.parser_settings = {'add_site_magnetization': True, 'add_structure': True}
    ...
    inputs.max_iterations = Int(2)
    # Submit the requested workchain with the supplied inputs
    run_get_node(workchain, **inputs)


if __name__ == '__main__':
    # Code_string is chosen among the list given by 'verdi code list'
    CODE_STRING = 'myvasp@localhost'
